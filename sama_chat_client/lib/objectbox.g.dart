...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    name: 'MessageModel',
    lastPropertyId: const obx_int.IdUid(17, 8330640059358737630),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(17, 8330640059358737630),
        name: 'dbStatus',
        type: 6,
        flags: 0,
      ),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    AttachmentModel: obx_int.EntityDefinition<AttachmentModel>(
      ...
      objectToFB: (AttachmentModel object, fb.Builder fbb) {
        final fileIdOffset = object.fileId == null
            ? null
            : fbb.writeString(object.fileId!);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final bidParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          4,
        );
        ...
        final fileBlurHashParam = const fb.StringReader(
          asciiOptimization: true,
        ...
        final fileHeightParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          16,
        );
        final fileWidthParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          18,
        );
    ...
    MessageModel: obx_int.EntityDefinition<MessageModel>(
      ...
      objectToFB: (MessageModel object, fb.Builder fbb) {
        ...
        fbb.addInt64(16, object.dbStatus);
        fbb.finish(fbb.endTable());
        return object.bid ?? 0;
      },
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final cidParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 10, '');
        final isOwnParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          28,
          false,
        ...
        final tParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          16,
        );
        final isTempRepliedParam = const fb.BoolReader().vTableGetNullable(
          buffer,
          rootOffset,
          30,
        );
        final isEditedParam = const fb.BoolReader().vTableGetNullable(
          buffer,
          rootOffset,
          34,
        );
        final object =
            MessageModel(
              ...
              ..dbExtension = const fb.StringReader(
                asciiOptimization: true,
        ...
        object.replyMessageBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          24,
          0,
        ...
        object.senderBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          26,
          0,
    ...
    UserModel: obx_int.EntityDefinition<UserModel>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final recentActivityParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          14,
        );
        ...
        object.avatarBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          26,
          0,
    ...
    ConversationModel: obx_int.EntityDefinition<ConversationModel>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final unreadMessagesCountParam = const fb.Int64Reader()
            .vTableGetNullable(buffer, rootOffset, 18);
        final descriptionParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGetNullable(buffer, rootOffset, 16);
        final isEncryptedParam = const fb.BoolReader().vTableGetNullable(
          buffer,
          rootOffset,
          32,
        );
        ...
        object.lastMessageBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          20,
          0,
        ...
        object.avatarBind.attach(store);
        object.opponentBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          28,
          0,
        ...
        object.ownerBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          30,
          0,
        ...
        object.draftMessageBind.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          34,
          0,
...
class AttachmentModel_ {
  ...
  static final bid = obx.QueryIntegerProperty<AttachmentModel>(
    _entities[0].properties[0],
  );

  /// See [AttachmentModel.fileId].
  static final fileId = obx.QueryStringProperty<AttachmentModel>(
    _entities[0].properties[1],
  );

  /// See [AttachmentModel.fileName].
  static final fileName = obx.QueryStringProperty<AttachmentModel>(
    _entities[0].properties[2],
  );

  /// See [AttachmentModel.fileBlurHash].
  static final fileBlurHash = obx.QueryStringProperty<AttachmentModel>(
    _entities[0].properties[3],
  );

  /// See [AttachmentModel.url].
  static final url = obx.QueryStringProperty<AttachmentModel>(
    _entities[0].properties[4],
  );

  /// See [AttachmentModel.contentType].
  static final contentType = obx.QueryStringProperty<AttachmentModel>(
    _entities[0].properties[5],
  );

  /// See [AttachmentModel.fileHeight].
  static final fileHeight = obx.QueryIntegerProperty<AttachmentModel>(
    _entities[0].properties[6],
  );

  /// See [AttachmentModel.fileWidth].
  static final fileWidth = obx.QueryIntegerProperty<AttachmentModel>(
...
class AvatarModel_ {
  /// See [AvatarModel.bid].
  static final bid = obx.QueryIntegerProperty<AvatarModel>(
    _entities[1].properties[0],
  );

  /// See [AvatarModel.fileId].
  static final fileId = obx.QueryStringProperty<AvatarModel>(
    _entities[1].properties[1],
  );

  /// See [AvatarModel.fileName].
  static final fileName = obx.QueryStringProperty<AvatarModel>(
    _entities[1].properties[2],
  );

  /// See [AvatarModel.fileBlurHash].
  static final fileBlurHash = obx.QueryStringProperty<AvatarModel>(
    _entities[1].properties[3],
  );

  /// See [AvatarModel.imageUrl].
  static final imageUrl = obx.QueryStringProperty<AvatarModel>(
...
class MessageModel_ {
  ...
  static final bid = obx.QueryIntegerProperty<MessageModel>(
    _entities[2].properties[0],
  );

  /// See [MessageModel.id].
  static final id = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[1],
  );

  /// See [MessageModel.from].
  static final from = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[2],
  );

  /// See [MessageModel.cid].
  static final cid = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[3],
  );

  /// See [MessageModel.body].
  static final body = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[4],
  );

  /// See [MessageModel.t].
  static final t = obx.QueryIntegerProperty<MessageModel>(
    _entities[2].properties[5],
  );

  /// See [MessageModel.createdAt].
  static final createdAt = obx.QueryDateProperty<MessageModel>(
    _entities[2].properties[6],
  );

  /// See [MessageModel.dbExtension].
  static final dbExtension = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[7],
  );

  /// See [MessageModel.repliedMessageId].
  static final repliedMessageId = obx.QueryStringProperty<MessageModel>(
  ...
  static final isOwn = obx.QueryBooleanProperty<MessageModel>(
    _entities[2].properties[11],
  );

  /// See [MessageModel.isTempReplied].
  static final isTempReplied = obx.QueryBooleanProperty<MessageModel>(
    _entities[2].properties[12],
  );

  /// See [MessageModel.forwardedMessageId].
  static final forwardedMessageId = obx.QueryStringProperty<MessageModel>(
    _entities[2].properties[13],
  );

  /// See [MessageModel.isEdited].
  static final isEdited = obx.QueryBooleanProperty<MessageModel>(
    _entities[2].properties[14],
  );

  /// See [MessageModel.dbStatus].
  static final dbStatus = obx.QueryIntegerProperty<MessageModel>(
...
class UserModel_ {
  /// See [UserModel.bid].
  static final bid = obx.QueryIntegerProperty<UserModel>(
    _entities[3].properties[0],
  );

  /// See [UserModel.id].
  static final id = obx.QueryStringProperty<UserModel>(
    _entities[3].properties[1],
  );

  /// See [UserModel.deviceId].
  static final deviceId = obx.QueryStringProperty<UserModel>(
  ...
  static final recentActivity = obx.QueryIntegerProperty<UserModel>(
...
class ConversationModel_ {
  ...
  static final bid = obx.QueryIntegerProperty<ConversationModel>(
    _entities[4].properties[0],
  );

  /// See [ConversationModel.id].
  static final id = obx.QueryStringProperty<ConversationModel>(
    _entities[4].properties[1],
  );

  /// See [ConversationModel.createdAt].
  static final createdAt = obx.QueryDateProperty<ConversationModel>(
    _entities[4].properties[2],
  );

  /// See [ConversationModel.updatedAt].
  static final updatedAt = obx.QueryDateProperty<ConversationModel>(
    _entities[4].properties[3],
  );

  /// See [ConversationModel.type].
  static final type = obx.QueryStringProperty<ConversationModel>(
    _entities[4].properties[4],
  );

  /// See [ConversationModel.name].
  static final name = obx.QueryStringProperty<ConversationModel>(
    _entities[4].properties[5],
  );

  /// See [ConversationModel.description].
  static final description = obx.QueryStringProperty<ConversationModel>(
  ...
  static final isEncrypted = obx.QueryBooleanProperty<ConversationModel>(
