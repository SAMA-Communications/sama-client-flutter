...
class ReplyMessageWidget extends StatelessWidget {
  ...
  late final MessageModel? replyMessage;

  ReplyMessageWidget(this.message, this.onTap, {super.key}) {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MediaAttachmentBloc, MediaAttachmentState>(
                      ...
                      child: Opacity(
                        ...
                        child: replyMessage?.hasAttachments() ?? false
                            ? _buildAttachmentWidget(
                                replyMessage!.attachments.first, context)
                            : Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: snapshot.data!.isEmpty &&
                        validateBlurhash(attachment.fileBlurHash ?? '')
                    ? BlurHashImage(attachment.fileBlurHash!)
                    : isImageType
