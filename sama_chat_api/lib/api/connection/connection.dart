...
class SamaConnectionService {
  ...
  SamaConnectionService._() {
    ...
    ConnectivityManager.instance.connectivityStream.listen((
      networkConnectionState,
    ) {
      log(
        '[SamaConnectionService][network connection changed to $networkConnectionState]',
      );
  ...
  Future<WebSocketChannel> connect() async {
    log('[SamaConnectionService][connect]');
  ...
  Future<Map<String, dynamic>> sendRequest(
    ...
    var request = {
      'request': {requestName: requestData, 'id': requestId},
    };
  ...
  void _processError(error) {
    log('[SamaConnectionService][_processError]', stringData: error.toString());
  }

  void _processData(String data) {
    log('[SamaConnectionService][_processData]', stringData: data);
